        ...
        <div className="w-80 bg-gray-900 border-r border-gray-800 flex flex-col overflow-hidden">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
                <TabsList className="grid grid-cols-5 border-b border-gray-800 rounded-none">
                    ...
                    <TabsTrigger value="videos" className="text-xs py-3">
                        Videos
                    </TabsTrigger>
                    <TabsTrigger value="photos" className="text-xs py-3">
                        Photos
                    </TabsTrigger>
                    <TabsTrigger value="audio" className="text-xs py-3">
                        Audio
                    </TabsTrigger>
                    <TabsTrigger value="effects" className="text-xs py-3">
                        Effects
                    </TabsTrigger>
                </TabsList>

                <div className="flex-grow overflow-y-auto">
                    <TabsContent value="text" className="p-4 h-full">
                        <SubtitleEditor />
                    </TabsContent>

                    <TabsContent value="videos" className="p-4 h-full">
                    ...
                    <TabsContent value="audio" className="p-4 h-full">
                        <AudioManager />
                    </TabsContent>

                    <TabsContent value="effects" className="p-4 h-full">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                ...
                                <div
                                    key={effect}
                                    className="relative rounded overflow-hidden aspect-square bg-gray-800 cursor-pointer"
                                >
